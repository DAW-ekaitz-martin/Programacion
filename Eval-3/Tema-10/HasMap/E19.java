...
public class E19 {
    public static void main(String[] args) {
        ...
        Alumno a2 = new Alumno("2273445", "Gaizka", 7.9);
        Alumno a3 = new Alumno("2233745", "Mateo", 6.3);
        Alumno a4 = new Alumno("2233045", "Walid", 8.4);
        Alumno a5 = new Alumno("22330445", "Marcos", 7.4);
        Alumno a6 = new Alumno("2233445", "Ekaitz", 2.9);
        Alumno a7 = new Alumno("2273445", "Gaizka", 7.9);
        Alumno a8 = new Alumno("22339445", "Nacho", 6.3);
        Alumno a9 = new Alumno("2233045", "Walid", 7.4);
        ...
        //Ordenar las notas en un ArrayList
        ArrayList<Double> notasOrdenadas = new ArrayList<>();
        for(Map.Entry<String, Alumno> en : alumnosHash.entrySet()) {
            notasOrdenadas.add(en.getValue().getNota());
        }
        ...
        System.out.println("ArrayList de notas ORDENADO:");
